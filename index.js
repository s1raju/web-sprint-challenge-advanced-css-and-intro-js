...
console.log(artists.splice(8, 1, vincent));
...
console.log(addArtist(20, "Siraj Sirajuddin", "1969 - 2021", "Web Design", "USA", "cool dude, average painter"));
